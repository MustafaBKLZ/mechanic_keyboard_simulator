...
{
    // Kaynak
    // https://www.codeproject.com/Articles/9351/Background-applications-listening-for-keyboard-act
    ...
    public class Form1 : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "Form1";
            this.Text = "Mechanical Keyboard Simulator";
        ...
        private void KeyboardListener_s_KeyEventHandler(object sender, EventArgs e)
        {
            ...
            if (eventArgs.m_Msg == 257)
            {

                // NOT: Ses dosyalarý bin/degug içerisinde olmalýdýr.
                // NOT: Ses dosyalarý bin/degug içerisinde olmalýdýr.
                // NOT: Ses dosyalarý bin/degug içerisinde olmalýdýr.
                // NOT: Ses dosyalarý bin/degug içerisinde olmalýdýr.
                // NOT: Ses dosyalarý bin/degug içerisinde olmalýdýr.
                ...
                {
                    case "Return":
                        PlayFile(System.Windows.Forms.Application.StartupPath + "\\enter.wav");
                        break;
                    case "Back":
                        PlayFile(System.Windows.Forms.Application.StartupPath + "\\back.wav");
                        break;
                    case "Space":
                        PlayFile(System.Windows.Forms.Application.StartupPath + "\\space.wav");
                        break;
                    default:
                        PlayFile(System.Windows.Forms.Application.StartupPath + "\\key.wav");
                        break;
                }
                // NOT: Ses dosyalarý bin/degug içerisinde olmalýdýr.
                // NOT: Ses dosyalarý bin/degug içerisinde olmalýdýr.
